...
public class GameWindow {
    ...
    /**
     * Displays the multiplayer scene
     */
    public void startMultiChallenge() { loadScene(new MultiplayerScene(this));}

    /**
     * Displays the game over screen
     * @param game The Game being played
     */
    public void startChallengeLost(Game game) { loadScene(new ScoresScene(this, game)); }
    ...
    /**
     * Displays the multiplayer channel select screen
     */
